...
function optionListII($agents){
    echo "<select id='select-2a9c' name='deleteAgent' class='u-border-1 u-border-grey-30 u-input u-input-rectangle'>";
    foreach($agents as $element){
        echo "<option value=".$element['agent_name'].">".$element['agent_name']."</option>";
    }
    echo "</select>";
    return $element['id_agent'];
}
